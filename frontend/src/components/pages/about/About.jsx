...
function About() {
  ...
  return (
    <div className="about">
      <span className="animate__animated animate__fadeInDown heading">
        About
      </span>
      <div className="p-left a-left a-intro">
        <div className="animate__animated animate__zoomInLeft p-left-detail a-left-detail a-intro-detail">
          ...
          <div className="l-div a-div ">
            <span>&lt;p&gt;</span>
            <p>
              As a Computer Science and Engineering student from Bhilai
              Institute of Technology, Durg, I am a web development enthusiast
              with passionate in learning new web technologies. Cuurently I am
              pushing up my skills in MERN Stack. A nimble and passionate
              learner, I embark on quests to craft captivating websites and
              applications that astound and inspire. When I'm not conjuring
              code, you'll find me on the football field, kicking goals, or
              delving into the mysteries of Indian Mythology.🌟
            </p>
            <span>&lt;/p&gt;</span>
          </div>
        </div>
      ...
      <div className="p-left a-left">
        <div className="animate__animated animate__zoomInLeft p-left-detail a-left-detail ">
          ...
          <div className="l-div">
            ...
            <div
              className="a-testi"
              style={{ width: "80vw", padding: "0 auto" }}
            >
              <Slider
                dots={true}
                autoplaySpeed={2500}
      ...
      <div className="p-left a-left">
        <div
          className="animate__animated animate__zoomInLeft p-left-detail a-left-detail "
          style={{ padding: "0" }}
        >
      ...
      <div className="p-left a-left">
        <div className="animate__animated animate__zoomInLeft p-left-detail a-left-detail ">
          ...
          <div className="l-div">
            <span style={{ color: "#d073fc" }}>
              Found me interesteing so far?
            </span>
            <div className="mySocials">
              ...
              <a
                rel="noreferrer"
                target="_blank"
                href="https://devanshshrivastava07@gmail.com"
              >
                <div>
                  <AiOutlineMail />
                </div>
